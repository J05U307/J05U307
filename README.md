...
¡Hola! Soy **Josue**, desarrollador **Backend** con especialización en **Java** y **Spring Boot**.  
Me apasiona construir aplicaciones **robustas**, **escalables** y con **código limpio**, aplicando siempre buenas prácticas y arquitecturas modernas.

Actualmente curso **Ingeniería de Sistemas** y desarrollo proyectos personales y profesionales para fortalecer mi portafolio.

> 💡 *“El código limpio no se escribe, se cuida.”*
...
Convertirme en un **Backend Developer Senior**, capaz de diseñar e implementar **sistemas distribuidos** y **arquitecturas escalables** que resuelvan problemas reales con software de calidad.
